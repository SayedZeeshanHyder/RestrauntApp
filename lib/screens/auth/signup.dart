...
import 'package:mprapp/services/firestoreservices.dart';
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              InkWell(
                ...
                onTap: () async {
                  ...
                  if (usernameController.text.isEmpty) {
                    ...
                    bool authComplete = await AuthServices.signUpUser(
                    ...
                    bool userDataStored = await FirestoreServices.addUser(
                        phonenoController.text, dobController.text,context);
              ...
              const Text(
                "By clicking on SignUp you agree to the following Terms & Conditions",
